...
class Communication:
    ...
    def pos_cmd_callback(self, msg):
        ...
        if self.vehicle_id == '0':
            ...
            target_raw_pose.position.y = msg.position.y - 3
            target_raw_pose.position.z = msg.position.z
        elif self.vehicle_id == '1':
            target_raw_pose.position.x = msg.position.x - 3
            target_raw_pose.position.y = msg.position.y - 3
            target_raw_pose.position.z = msg.position.z
        elif self.vehicle_id == '2':
            target_raw_pose.position.x = msg.position.x
            target_raw_pose.position.y = msg.position.y - 6
            target_raw_pose.position.z = msg.position.z
        elif self.vehicle_id == '3':
            target_raw_pose.position.x = msg.position.x - 3
            target_raw_pose.position.y = msg.position.y - 6
            target_raw_pose.position.z = msg.position.z
        elif self.vehicle_id == '4':
            target_raw_pose.position.x = msg.position.x
            target_raw_pose.position.y = msg.position.y - 9
            target_raw_pose.position.z = msg.position.z
        elif self.vehicle_id == '5':
            target_raw_pose.position.x = msg.position.x - 3 
            target_raw_pose.position.y = msg.position.y - 9
            target_raw_pose.position.z = msg.position.z

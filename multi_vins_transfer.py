...
vehicle_type = rospy.get_param("/iris_vins_transfer/vehicle_type")
vehicle_num = rospy.get_param("/iris_vins_transfer/vehicle_num")
...
bias = np.array([[0,3,0],[3,3,0],[0,6,0],[3,6,0],[0,9,0],[3,9,0],[0,12,0],[3,12,0]])
# bias = np.array([[-7,7,0],[-7,5,0],[-7,3,0],[-7,1,0],[-7,-1,0],[-7,-3,0],[-7,-5,0],[-7,-7,0]])

def multi_vins_callback(data, i):
#    bias = rospy.get_param("/global_bias")
